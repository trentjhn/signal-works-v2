  ...
  return (
    <div className={`brand-img group/img relative overflow-hidden ${bordered ? 'rounded-sm border border-white/10' : ''} ${className}`}>
      <img
        ...
        loading="lazy"
        decoding="async"
        className={`w-full h-full object-cover grayscale group-hover/img:grayscale-0 group-hover:grayscale-0 transition-[filter] duration-400 ease-swift ${imgClassName}`}
      />
