  ...
  return (
    <section className="relative w-full pt-24 pb-32 lg:pt-32 lg:pb-40 z-20 border-t border-white/5 overflow-hidden">
      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-[6%] relative z-10">
        <div
          id="book"
          className="hover:bg-white/[0.04] rounded-sm p-8 lg:px-12 lg:py-14 flex flex-col items-center justify-center gap-6 relative overflow-hidden group border border-white/5 hover:border-white/10 backdrop-blur-lg transition-all duration-500"
        >
