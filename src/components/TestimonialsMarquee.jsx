    ...
    <section id="about" className="relative w-full py-24 lg:py-40 overflow-hidden z-20 border-t border-white/5">
      ...
      <div className="relative z-10 px-6 lg:px-[6%] max-w-[1600px] mx-auto">
        ...
        <div className="max-w-3xl mb-16 lg:mb-20">
          ...
          <h2 className="leading-[1.0] animate-reveal delay-100 lg:text-7xl text-4xl font-medium text-white tracking-tighter">
            Who you work
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mb-12 items-stretch">
          {founders.map((f, idx) => (
            <FlashlightCard
              key={idx}
              className="hover:bg-white/[0.04] transition-all duration-500 border border-white/5 hover:border-white/10 rounded-sm backdrop-blur-lg p-8 lg:p-10 relative overflow-hidden flex flex-col animate-reveal h-full"
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                {/* Headshot */}
                <div className="w-[200px] h-[200px] rounded-sm border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.02] flex items-center justify-center relative overflow-hidden mb-8">
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,rgba(168,85,247,0.08),transparent_60%)]"></div>
                  <span className="relative text-5xl font-medium text-white/40 tracking-tight">{f.initials}</span>
                </div>
        ...
        {/* Single closing line */}
        <p className="text-base lg:text-lg text-white/50 font-light text-center max-w-3xl mx-auto animate-reveal delay-500">
